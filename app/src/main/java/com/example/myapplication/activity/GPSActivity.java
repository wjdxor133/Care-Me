...
public class GPSActivity extends AppCompatActivity
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                Log.e("로그","로그 값 : "+locationList.get(locationList.size() - 1));
 ...
 //위도 경도 업데이트 메소드
    public void Updatelocation(){
        ...
        DocumentReference docRef = db.collection("GPS").document(firebaseUser.getUid());
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                      ...
                      float  f_latitude = Float.parseFloat(document.getData().get("latitude").toString());
                      float f_longitude = Float.parseFloat(document.getData().get("longitude").toString());
